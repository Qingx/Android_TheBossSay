...
//        }
    ...
    public static void showClean(Activity activity, UIActionSheetDialog.OnItemClickListener cleanlistener) {
        ...
        new UIActionSheetDialog.ListIOSBuilder(activity)
                .addItem(clean)
                .setItemsTextColorResource(R.color.md_red_500)
                .setTitle(title)
                .setTitleTextSize(14)
     ...
     * @param context
     */
    public static TimePickerView createTimeOptions(Context context, long time, boolean isLimitTime, OnTimeSelectListener listener) {
        ...
        TimePickerView picker = new TimePickerBuilder(context, listener)
                ...
                .setSubmitColor(ColorUtils.getColor(R.color.md_green_500))//确定按钮文字颜色
     ...
     * @param context
     */
    public static TimePickerView createTimeOptions(Context context, String title, long time, boolean isLimitTime, OnTimeSelectListener listener) {
        Calendar selectedDate = Calendar.getInstance();
        Calendar startDate = Calendar.getInstance();
        Calendar endDate = Calendar.getInstance();
     ...
     * @param context
     */
    public static TimePickerView showYearSelect(Context context, int oldYear, OnTimeSelectListener listener) {
        Calendar selectedDate = Calendar.getInstance();
        Calendar startDate = Calendar.getInstance();
        Calendar endDate = Calendar.getInstance();
        ...
        startDate.set(1997, 0, 1);
        if (oldYear > 1) {
            selectedDate.set(Calendar.YEAR, oldYear);
        }
     ...
     * @param context
     */
    public static TimePickerView showMonthSelect(Context context, int oldMonth, OnTimeSelectListener listener) {
        Calendar selectedDate = Calendar.getInstance();
        Calendar startDate = Calendar.getInstance();
        Calendar endDate = Calendar.getInstance();
        ...
        if (oldMonth > 1) {
            int value = oldMonth - 1;
            if (value < 0) value = 0;

            selectedDate.set(Calendar.MONTH, value);
        }
     ...
     * @param context
     */
    public static TimePickerView showYY_MMSelect(Context context, int oldYear, int oldMonth, OnTimeSelectListener listener) {
        Calendar selectedDate = Calendar.getInstance();
        Calendar startDate = Calendar.getInstance();
        Calendar endDate = Calendar.getInstance();
        ...
        if (oldYear > 1) {
            selectedDate.set(Calendar.YEAR, oldYear);
            selectedDate.set(Calendar.MONTH, oldMonth);
        }
