...
/**
 * Created by Xiang on 2021/7/15 14:32
 * @description
 * @email Cymbidium@outlook.com
 */
class CreateFolderDialog : DialogFragment() {
    companion object {
        fun showDialog(fragmentManager: FragmentManager, tag: String): CreateFolderDialog {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_create_folder, container, false)
    }
