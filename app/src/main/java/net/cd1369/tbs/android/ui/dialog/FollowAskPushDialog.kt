...
import kotlinx.android.synthetic.main.dialog_follow_ask_push.*
 ...
 */
class FollowAskPushDialog : DialogFragment() {
    companion object {
        fun showDialog(fragmentManager: FragmentManager, tag: String): FollowAskPushDialog {
            return FollowAskPushDialog().apply {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_follow_ask_push, container, false)
    }
