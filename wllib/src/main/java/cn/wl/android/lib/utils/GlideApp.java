...
public class GlideApp {
     ...
     * @param displayView
     */
    private static void displayByString(String resource, ImageView displayView) {
        RequestOptions options = getOptions().clone()
                .dontAnimate()
                .centerCrop();
     ...
     * @param displayView
     */
    public static void displayNormal(String resource, ImageView displayView) {
        RequestOptions options = getOptions().clone()
                .dontAnimate();
     ...
     * @param displayView
     */
    public static void displayHead(Object resource, ImageView displayView) {
        RequestOptions options = getOptions().clone()
                .dontAnimate()
                .centerCrop()
     ...
     * @param displayView
     */
    public static void displayHead(Object resource, ImageView displayView, @DrawableRes int drawRes) {
        RequestOptions options = getOptions().clone()
                .dontAnimate()
                .centerCrop()
                .placeholder(drawRes)
