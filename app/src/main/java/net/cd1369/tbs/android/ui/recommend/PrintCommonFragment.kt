...
import net.cd1369.tbs.android.ui.recommend.adapter.PrintRootAdapter

class PrintCommonFragment : BaseListFragment(), OnPrintConsumer {

    private var mSubjectId: String = ""
    private var mHotAdapter: PrintRootAdapter? = null

    companion object {
        fun newIns(id: String): PrintCommonFragment {
            val fragment = PrintCommonFragment()
