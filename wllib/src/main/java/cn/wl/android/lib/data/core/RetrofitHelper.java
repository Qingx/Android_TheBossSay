...
import cn.wl.android.lib.core.NullOnEmptyConverterFactory;
...
public class RetrofitHelper {
            ...
            synchronized (RetrofitHelper.class) {
                if (mResourceRetrofit == null) {
                    mResourceRetrofit = new Retrofit.Builder()
                            ...
                            .addConverterFactory(GsonConverterFactory.create(Gsons.getGson()))
                            .baseUrl(WLConfig.getBaseUrl())
                            .client(OKHttpHelper.getResource())
                            .build();
                }
            }
        }
     ...
     * @return
     */
    public <Ser> Ser getUpload(Class<Ser> clazz) {
        return getUpload().create(clazz);
    }
